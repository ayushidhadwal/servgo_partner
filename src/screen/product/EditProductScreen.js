...
const EditProductScreen = ({route, navigation}) => {
  ...
  const {productDetails, loading: isLoading} = useGetProductDetails(productId);
  ...
  useEffect(() => {
    if (productDetails) {
      ...
      setArabicTitle(productDetails.titleArabic);
      setSellingPrice(String(productDetails.SellingPrice));
      setMRP(String(productDetails.MRP));
      setInventory(String(productDetails.inventory));
      setCategoryId(Number(productDetails.category));
      setSubCategoryId(Number(productDetails.sub_category));
      setDiscount(String(productDetails.discount));
      setDesc(productDetails.description);
      setArabicDesc(productDetails.arabicDescription);
      setProductImg1({
        uri: URL + productDetails.productImage1,
      });
      setProductImg2({
        uri: URL + productDetails.productImage2,
      });
      setProductImg3({
        uri: URL + productDetails.productImage3,
      });
      setProductImg4({
        uri: URL + productDetails.productImage4,
      });
    }
  }, [productDetails]);
      ...
      <KeyboardAwareScrollView
        ...
        <View style={styles.rowStyles}>
          <Pressable
            ...
            {productImg1.uri ? (
              <Image source={{uri: productImg1.uri}} style={styles.imgStyles} />
            ) : (
              <MaterialIcons
                name="add-a-photo"
                size={24}
          ...
          <Pressable
            ...
            {productImg2.uri ? (
              <Image source={{uri: productImg2.uri}} style={styles.imgStyles} />
            ) : (
              <MaterialIcons
                name="add-a-photo"
                size={24}
          ...
          <Pressable
            ...
            {productImg3.uri ? (
              <Image source={{uri: productImg3.uri}} style={styles.imgStyles} />
            ) : (
              <MaterialIcons
                name="add-a-photo"
                size={24}
          ...
          <Pressable
            ...
            {productImg4.uri ? (
              <Image source={{uri: productImg4.uri}} style={styles.imgStyles} />
            ) : (
              <MaterialIcons
                name="add-a-photo"
                size={24}
